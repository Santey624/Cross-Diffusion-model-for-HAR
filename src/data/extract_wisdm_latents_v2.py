# ============================================================
# Extract WISDM Latents V2 (D=16, T=64) using VAE V2
# ============================================================
...
BATCH_SIZE      = 64
CHECKPOINT_PATH = "checkpoints/sensor_vae_v2/best_model.pt"
NORMALIZER_PATH = "data/sensor_normalizer_combined.npz"
WISDM_ROOT      = "data/wisdm/arrays"

OUTPUT_DIR = Path("data/wisdm_latents_v2")
...
def main():
    print(f"\n{'='*60}")
    print("Extracting WISDM Latents V2 (D=16, T=64)")
    print(f"{'='*60}\n")
