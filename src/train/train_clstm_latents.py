...
#   --robust  50% of batches randomly mask 1-3 sensors (diffusion imputation)
# ============================================================
...
def main():
    ...
    if ROBUST:
        ...
        # infer latent_dim from saved weights (not always stored in config)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for batch in train_loader:
            ...
            if ROBUST and random.random() < MASK_PROB:
                ...
                # Denormalize and update only missing sensors
