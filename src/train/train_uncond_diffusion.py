# ============================================================
# Train Unconditional Sensor Diffusion Model
# Learns p(z | sensor_type) without conditioning on other sensors
# Used with classifier guidance at inference
# ============================================================
...
OUT_DIR = Path("checkpoints/uncond_diffusion")
...
def main():
    print(f"\n{'='*60}")
    print("Training Unconditional Sensor Diffusion Model")
    ...
    # Model
    print("\nCreating unconditional model...")
    model = create_uncond_diffusion_model(
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for batch_tensors in pbar:
            ...
            # Forward (unconditional — only z_t + sensor type)
            opt.zero_grad(set_to_none=True)
            with torch.cuda.amp.autocast(enabled=(USE_AMP and DEVICE == "cuda")):
                noise_pred = model(z_t=z_t, t=t, sensor_idx=sensor_idx)
