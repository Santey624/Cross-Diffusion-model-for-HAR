# ============================================================
# Train Sensor Conditional Diffusion V3 on VAE V2 Latents
# Input latent shape: (B, 7, 16, 64) — was (B, 7, 8, 32)
# Architecture adapts automatically from loaded latent shape
# ============================================================
...
COGAGE_LATENTS_DIR = Path("data/sensor_latents_v2")
WISDM_LATENTS_DIR  = Path("data/wisdm_latents_v2")
OUT_DIR            = Path("checkpoints/sensor_diffusion_v3_v2")
...
# Model — slightly larger d_model for bigger latent space (16×64 vs 8×32)
D_MODEL    = 192
NUM_HEADS  = 4
NUM_BLOCKS = 4
DROPOUT    = 0.1
...
def main():
    ...
    print(f"\n{'='*70}")
    print("Training Diffusion V3 on VAE V2 Latents (D=16, T=64)")
    ...
    # Load CogAge V2 latents
    print("Loading CogAge V2 latents...")
    cogage = {}
    ...
    # Load WISDM V2 latents
    print("\nLoading WISDM V2 latents...")
    wisdm = {}
    for name in SENSOR_NAMES:
    ...
    # Model — latent_dim and t_shared read from data
